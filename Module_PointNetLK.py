# -*- coding: utf-8 -*-
"""
Created on Fri May 14 01:28:25 2021
...
class PointLK(nn.Module):
    def __init__(self, ptnet, delta=1.0e-2, learn_delta=False):
        ...
        self.dt = nn.Parameter(twist.view(1, 6), requires_grad=learn_delta)
    ...
    def rsq(r):
        ...
        return F.mse_loss(r, z, size_average=False)
    ...
    def comp(g, igt):
        ...
        return F.mse_loss(A, I, size_average=True) * 16
